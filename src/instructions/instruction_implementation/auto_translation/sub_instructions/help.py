...
class Help(InstructionParent):
    ...
    def run(self, message):
        ...
        ret += "\n"
        ret += "`" + self.commandline_config.first_keyword + " auto-translate set [langs]` sets the current channel to be automatically translated\n"
        ...
        ret += "usage example : `" + self.commandline_config.first_keyword + " auto-translate set fr en` for a french / english auto translation\n"
        ret += "\n"
        ret += "`" + self.commandline_config.first_keyword + " auto-translate get` displays the auto translate instruction for the current channel\n"
        ret += "\n"
        ret += "`" + self.commandline_config.first_keyword + " auto-translate remove` removes the auto translation from the current channel\n"
        return ret
