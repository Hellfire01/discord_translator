...
class Core:
    def __init__(self, commandline_config, database_config, discord_config, translate_config, logger, database_access, api_config, google_translate_api, security_config):
        ...
        self.__security_config = security_config
